...
export default async function TokenPage({ params }: PageProps) {
  ...
  const [info, security, holders, kolTraders, signals] = await Promise.all([
  ...
  return <TokenDetail address={address} info={info} security={security} holders={holders} kolTraders={kolTraders} signals={signals} />;
}
